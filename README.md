...
- Smart offline table-of-contents generation: existing ebook navigation is preserved, then PageForge recognizes semantic headings, chapter wording, title-like classes, and relative type size. PDF chapter headings use wording and relative type size. EPUB receives reader navigation, MOBI/KF8 receives a linked contents page, and ebook-to-PDF receives a visible contents page. No OCR service or network call is used.
