...
- Automatic chapters 2.0 has one visible On/Off control for PDF and every ebook input. It rebuilds PDF text lines from page coordinates, combines document-wide layout patterns with semantic headings, typography, multilingual numbering, subtitles, and publisher navigation, and rejects contents pages, duplicates, repeated running headers, and isolated decorative titles. Users can override it by manually marking page cards as green first-class, yellow second-class, or black third-class chapters and editing every title. Manual hierarchy is written into EPUB 3 navigation, EPUB NCX compatibility navigation, classic MOBI reader navigation, and KF8/AZW3 NCX navigation without any OCR service or network call.
