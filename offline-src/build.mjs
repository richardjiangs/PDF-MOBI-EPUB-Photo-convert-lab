...
await writeFile(resolve(root, "outputs/PageForge-Local 3.0.html"), standaloneHtml);
...
await copyFile(resolve(root, "public/og-3.0.png"), resolve(root, "docs/og-3.0.png"));
...
console.log(`Built PageForge-Local 3.0.html (${(standaloneHtml.length / 1048576).toFixed(2)} MB), website, and GitHub Pages edition`);
